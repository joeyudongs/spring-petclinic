# Spring PetClinic Sample Application [![Java CI with Maven](https://github.com/joeyudongs/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/joeyudongs/spring-petclinic/actions/workflows/maven.yml)
